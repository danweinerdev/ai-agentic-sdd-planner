...
└── Diagrams/                     # Standalone diagrams (flat — generated by /diagram)
    └── <slug>.md
```
...
- `/implement` sets `status: complete` when the final phase finishes; `/debrief` and `/tend` backfill it if missed
